...
public class ResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView uCropView = (ImageView) findViewById(R.id.ucrops);
        Glide.with(this).load(getIntent().getData()).into(uCropView);

//        try {
//            UCropView uCropView = (UCropView) findViewById(R.id.ucrops);
